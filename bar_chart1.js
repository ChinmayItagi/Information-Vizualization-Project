function dashboard(id, fData){
    ...
    function pieChart(pD){
        ...
        var arc = d3.arc().outerRadius(pieDim.r - 10).innerRadius(50);

        // create a function to compute the pie slice angles.
        var pie = d3.pie().sort(null).value(function(d) { console.log(d.freq);return d.freq; });
